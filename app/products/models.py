...
class Product(models.Model):
    ...
    photos = models.ImageField(upload_to='product', blank=True)
    ...
    def content_html(self):
        return re.sub(
            r'#(?P<tag>\w+)',
            '<a href="/products/tags/\g<tag>">#\g<tag></a>',
            self.content,
        )
...
class Comment(models.Model):
    ...
    def __str__(self):
        return f'Comment (product: {self.product.pk}, author: {self.author.username})'
